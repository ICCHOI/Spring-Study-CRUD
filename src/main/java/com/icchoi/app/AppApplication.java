package com.icchoi.app;

import com.icchoi.app.entity.*;
import com.icchoi.app.repository.*;
...
public class AppApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		personRepository.save(new Person("최인창", "백엔드", "hello@test.com", "010-1234-5678"));
		socialMediaRepository.save(new SocialMedia("anonymous","null","null","anonymous"));
		interestsRepository.save(new Interests("League of Legends, VAROLANT, TFT"));
		interestsRepository.save(new Interests("Billboard music"));
		skillRepository.save(new Skill("Java",75));
		skillRepository.save(new Skill("Spring", 50));
		workRepository.save(new Work("Back-end","Carrot-Market","2020","Server Develop"));
	}
}
